...
nginx_menu() {
  ...
  ui_2col "$(ui_menu_num 03 'Restart')"           "$(ui_menu_num 04 'Reload' "$CYAN")"
  ui_2col "$(ui_menu_num 05 'Test Konfigurasi')"  "$(ui_menu_num 06 'Lihat Error Log')"
  ui_2col "$(ui_menu_num 07 'Lihat Konfigurasi')" "$(ui_menu_num 08 'Renew SSL Cert')"
  echo -e "${CYAN}$UI_BOX_MID${NC}"
